...
export function LargeSettingsModal() {
  ...
  return (
    <Dialog open={settingsModalOpen} onOpenChange={setSettingsModalOpen}>
      <DialogContent className="max-w-[1000px] w-[95vw] h-[80vh] p-0 overflow-hidden flex flex-row rounded-2xl border-none shadow-2xl">
        <DialogTitle className="sr-only">Settings</DialogTitle>
        <DialogDescription className="sr-only">Configure your project and account settings</DialogDescription>
        
        {/* Sidebar */}
        <div className="w-[240px] bg-[#F9FAFB] border-r border-gray-100 flex flex-col p-4 overflow-y-auto">
        ...
        <div className="flex-1 bg-white flex flex-col min-w-0">
          <div className="flex items-center justify-between p-6 border-b border-gray-50 h-16">
            <h2 className="text-lg font-bold text-gray-900">
              {settingsTab === 'github' ? 'GitHub' : 'Settings'}
            </h2>
            <button 
            ...
            {settingsTab === 'github' ? (
              <div className="max-w-3xl space-y-8">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <a href="#" className="flex items-center gap-1.5 text-[13px] font-medium text-gray-500 hover:text-gray-900 transition-colors">
                ...
                <div className="space-y-6">
                  <div className="flex items-start justify-between">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-orange-50 border border-orange-100">
                          ...
                          <span className="text-[10px] font-bold text-orange-700 uppercase">Not connected</span>
                        </div>
                      </div>
                    ...
                    <Button 
                      ...
                      disabled={loading}
                      className="bg-black hover:bg-black/90 text-white rounded-lg px-4 h-9 flex items-center gap-2 text-[13px] font-bold"
                    >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-orange-50 border border-orange-100">
                          <span className="text-[10px] font-bold text-orange-700 uppercase">Admin</span>
                        </div>
                      </div>
                      <p className="text-[13px] text-gray-500">
                    ...
                    {githubStatus.connected ? (
                      <div className="flex items-center gap-2 text-[13px] font-medium text-gray-600 bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-100">

      ...
      {isDone && message.url && (
        <div className="mt-3">
          <a
            ...
            className="flex items-center justify-between gap-3 px-4 py-3 bg-[#D2E3FC] hover:bg-[#C6DAFC] border border-[#1A73E8] rounded-xl transition-all group shadow-sm"
          >
            <div className="flex flex-col min-w-0">
              <span className="text-[11px] font-bold text-[#1A73E8]/70 uppercase tracking-wider">Live Preview</span>
              <span className="text-[14px] font-semibold text-[#0F172A] truncate">Open live preview</span>
            </div>
